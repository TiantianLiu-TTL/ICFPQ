...
/**
 * two approximate algorithms to process ICFPQ
 * @author Tiantian Liu
 */

public class AlgoICFPQ_inexact {
     ...
     * @return path
     */
    public static String icfpq_inexact(Point sPoint, Point tPoint, int qTime, String type) {
