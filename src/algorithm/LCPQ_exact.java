...
/**
 * two exact algorithms to process LCPQ
 * @author Tiantian Liu
 */

public class LCPQ_exact {
     ...
     * @return path
     */
    public static String lcpq_exact(Point sPoint, Point tPoint, int qTime, String type) {
...
//            System.out.println("parId " + i + " ave " + ave + " vol " + vol);
        ...
        String result = LCPQ_exact.lcpq_exact(new Point(1032.0,1371.0,0), new Point(1622.0,871.0,0), 1000, "exactNew");
