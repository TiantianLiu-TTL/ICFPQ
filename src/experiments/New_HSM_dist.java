...
/**
 * experiments to test effect of distance
 * @author Tiantian Liu
 */

public class New_HSM_dist {
    ...
    public static void run(String outFileTime, String outFileMemory, String outFileAcc, String outFileHit, String queryType) throws IOException {
        String resultTime = "distance" + "\t" + "exactNew" + "\t" + "exact" + "\t" + "inexactS" + "\t" + "inexactST" + "\t" + "baseline" + "\n";
        String resultMemo = "distance" + "\t" + "exactNew" + "\t" + "exact" + "\t" + "inexactS" + "\t" + "inexactST" + "\t" + "baseline" + "\n";
        String resultAcc = "distance" + "\t" + "exact" + "\t" + "inexactS" + "\t" + "inexactST" + "\n";
        String resultHit = "distance" + "\t" + "exact" + "\t" + "inexactS" + "\t" + "inexactST" + "\n";
...
//            ArrayList<Long> arrMem5 = new ArrayList<>();
            ...
            pointPairs = New_HSM_dist.getPointPairs(distances.get(i));
...
//                    if (queryType.equals("icaspq")) {
//                        result5 = LCPQ_baseline_gtg.lcpq_baseline2(ps, pe, queryTime, "exact");
//                    } else if (queryType.equals("icfpq")) {
//                        result5 = AlgoICFPQ_baseline2.icfpq_baseline2(ps, pe, queryTime, "exact");
//                    } else {
//                        System.out.println("something wrong with the query type");
//                    }
...
//            arrAccAll.add(arrAcc3);
            ...
            resultHit += (100 - notHit1) + "\t" + (100 - notHit2) + "\t" + (100 - notHit4) + "\n";
...
//        String queryType = "icfpq";
        ...
        String outFileTime = System.getProperty("user.dir") + "/result/" + "newHSM_distance_time_" + queryType + ".csv";
        String outFileMemory = System.getProperty("user.dir") + "/result/" + "newHSM_distance_memory_" + queryType + ".csv";
        String outFileAcc = System.getProperty("user.dir") + "/result/" + "newHSM_distance_acc_" + queryType + ".csv";
        String outFileHit = System.getProperty("user.dir") + "/result/" + "newHSM_distance_hit_" + queryType + ".csv";
        New_HSM_dist.run(outFileTime, outFileMemory, outFileAcc, outFileHit, queryType);
