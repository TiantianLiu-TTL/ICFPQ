...
//            ArrayList<Double> arrAcc3 = new ArrayList<>();
            ...
            pointPairs = SYN_dist.getPointPairs(distances.get(i));
            ...
            for (int j = 0; j < pointPairs.size(); j++) {
                ...
                for (int h = 0; h < 1; h++) {
                    ...
                    System.out.println("exact " + result1);
...
//                    System.out.println("inexactS memory " + mem2);
                    ...
                    System.out.println("inexactT " + result3);
...
//            arrAccAll.add(arrAcc3);
        ...
        FileOutputStream outputHit = new FileOutputStream(outFileHit);
...
//        String queryType = "icaspq";
        String outFileTime = System.getProperty("user.dir") + "/result/" + "SYN_distance_time_" + queryType + ".csv";
        String outFileMemory = System.getProperty("user.dir") + "/result/" + "SYN_distance_memory_" + queryType + ".csv";
        String outFileAcc = System.getProperty("user.dir") + "/result/" + "SYN_distance_acc_" + queryType + ".csv";
        String outFileHit = System.getProperty("user.dir") + "/result/" + "SYN_distance_hit_" + queryType + ".csv";
        SYN_dist.run(outFileTime, outFileMemory, outFileAcc, outFileHit, queryType);
