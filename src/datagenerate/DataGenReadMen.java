...
public class DataGenReadMen {
    ...
    public static String inputDoor = System.getProperty("user.dir") + "/inputfiles/Menzies/door.txt";
    public static String inputRoom = System.getProperty("user.dir") + "/inputfiles/Menzies/room.txt";
