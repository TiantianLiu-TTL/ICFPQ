...
//                                * HSMDataGenConstant.zoomLevel));
    ...
    public boolean saveDP() {
        try {
            FileWriter fwPar = new FileWriter(System.getProperty("user.dir") + "/inputfiles/HSM/Par_new.txt");
        ...
        try {
            FileWriter fwDoor = new FileWriter(System.getProperty("user.dir") + "/inputfiles/HSM/Door_new.txt");
