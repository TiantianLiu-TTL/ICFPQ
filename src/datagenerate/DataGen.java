	...
	public void linkFloors() {
		for (int i = 1; i < DataGenConstant.nFloor; i++) {
			...
			for (int j = 0; j < doors.size(); j++) {
				...
				if (parts.size() > 1) {
					System.out.println("something wrong with exit door's partition: datagenerate.DataGen.linkFloors");
				}
...
//				System.out.println("door generated with id = " + (newDoor.getmID() + 1) + " on floor = " + newDoor.getmFloor());
			...
			if (floorIndex < (floorNumber - 1)) IndoorSpace.iDoors.get(IndoorSpace.iNumberDoorsPerFloor - 6 + floorIndex * curSizeDoor).addFloor(floorIndex  + 1);
//			System.out.println((IndoorSpace.iDoors.get(210 + floorIndex * curSizeDoor).getmID() == (210 + floorIndex * curSizeDoor)) + " " + (210 + floorIndex * curSizeDoor));
			...
			if (floorIndex < (floorNumber - 1)) IndoorSpace.iDoors.get(IndoorSpace.iNumberDoorsPerFloor - 4 + floorIndex * curSizeDoor).addFloor(floorIndex  + 1);
//			System.out.println((IndoorSpace.iDoors.get(212 + floorIndex * curSizeDoor).getmID() == (212 + floorIndex * curSizeDoor)) + " " + (212 + floorIndex * curSizeDoor));
			...
			if (floorIndex < (floorNumber - 1)) IndoorSpace.iDoors.get(IndoorSpace.iNumberDoorsPerFloor - 3 + floorIndex * curSizeDoor).addFloor(floorIndex  + 1);
//			System.out.println((IndoorSpace.iDoors.get(213 + floorIndex * curSizeDoor).getmID() == (213 + floorIndex * curSizeDoor)) + " " + (213 + floorIndex * curSizeDoor));
			...
			if (floorIndex < (floorNumber - 1)) IndoorSpace.iDoors.get(IndoorSpace.iNumberDoorsPerFloor - 2 + floorIndex * curSizeDoor).addFloor(floorIndex  + 1);
...
//		System.out.println("Partition " + DataGenConstant.mID_Par + " created " + 
